...
describe('VnCard', () => {
  it('renders a rich selected card and responds to click and keyboard selection', () => {
    ...
    expect(selectable).toHaveClass('h-full', 'min-h-0', 'w-full', 'flex-1', 'self-stretch');
  ...
  it('carries list metadata and fills its intrinsic grid row', () => {
    renderWithProviders(
    ...
    expect(listItem).toHaveClass('h-full', 'flex-1', 'self-stretch');
  });
