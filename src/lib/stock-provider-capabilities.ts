...
export const STOCK_PROVIDERS: readonly StockProviderMeta[] = [
  ...
  { id: 'mandarake',          label: 'Mandarake',          kind: 'direct',    lookupCapabilities: ['direct_link', 'jan_lookup', 'title_search'],          resultCapability: 'structured_offers', supportLevel: 'limited',     physical: true,  physicalStockMode: 'store_name_online',                      cloudflare: false, branchParserImplemented: false, confirmedPhysicalUsable: false },
  ...
  { id: 'getchu',             label: 'Getchu',             kind: 'direct',    lookupCapabilities: ['direct_link', 'jan_lookup', 'title_search'],          resultCapability: 'structured_offers', supportLevel: 'supported',   physical: false, physicalStockMode: 'online_only',                            cloudflare: true,  branchParserImplemented: false, confirmedPhysicalUsable: false },
  ...
  { id: 'amiami',             label: 'AmiAmi',             kind: 'direct',    lookupCapabilities: ['direct_link', 'title_search'],                       resultCapability: 'search_leads',      supportLevel: 'manual_only', physical: false, physicalStockMode: 'online_only',                            cloudflare: true,  branchParserImplemented: false, confirmedPhysicalUsable: false },
  ...
  { id: 'geo',                label: 'GEO',                kind: 'direct',    lookupCapabilities: ['direct_link', 'title_search'],                       resultCapability: 'structured_offers', supportLevel: 'supported',   physical: true,  physicalStockMode: 'online_only',                            cloudflare: true,  branchParserImplemented: false, confirmedPhysicalUsable: false },
  { id: 'joshin',             label: 'Joshin',             kind: 'direct',    lookupCapabilities: ['direct_link', 'jan_lookup', 'title_search'],          resultCapability: 'structured_offers', supportLevel: 'limited',     physical: true,  physicalStockMode: 'phone_only',                             cloudflare: true,  branchParserImplemented: false, confirmedPhysicalUsable: false },
