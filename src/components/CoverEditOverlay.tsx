...
export function CoverEditOverlay({ vnId }: { vnId: string }) {
  ...
  return (
    <button
      ...
      className="absolute right-2 top-2 z-10 inline-flex min-h-[36px] items-center gap-1 rounded-md bg-black/70 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-white shadow-card backdrop-blur transition-opacity hover:bg-accent hover:text-bg can-hover:md:opacity-0 can-hover:md:group-hover:opacity-100 md:group-focus-within:opacity-100 can-hover:md:hover:opacity-100"
    >
