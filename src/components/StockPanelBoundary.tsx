    ...
    return (
      <section className="rounded-xl border border-status-dropped/40 bg-status-dropped/10 p-4 sm:p-5" role="alert">
        ...
        <button
          type="button"
          onClick={this.reset}
          className="mt-3 inline-flex min-h-[44px] items-center gap-1 rounded-md border border-status-dropped/50 bg-bg px-3 py-1.5 text-xs font-bold text-status-dropped hover:bg-status-dropped/15 focus-visible:outline focus-visible:outline-2 focus-visible:outline-status-dropped can-hover:sm:min-h-[36px]"
        >
