    ...
    <>
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button
          ...
          className="ml-auto inline-flex min-h-[44px] items-center gap-1 rounded-md border border-border bg-bg-elev/40 px-2 py-1 text-[11px] text-muted hover:border-accent hover:text-accent can-hover:sm:min-h-0"
        >
          {expanded
