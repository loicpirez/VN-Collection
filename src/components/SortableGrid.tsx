...
function SortableCard({ item, isDragGhost, disabled }: { item: CollectionCardApiItem; isDragGhost: boolean; disabled: boolean }) {
  ...
  // `w-full min-w-0` keeps the wrapper bound to its grid column on
  ...
  return (
    <div
      ...
      className={`group/sortable relative flex min-h-0 w-full min-w-0 items-stretch touch-none select-none ${
