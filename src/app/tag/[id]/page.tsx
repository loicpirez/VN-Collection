        ...
        */}
        ...
        >
          <Link
            ...
            className={`inline-flex min-h-[44px] items-center rounded px-2.5 py-1 can-hover:sm:min-h-0 ${tab === 'local' ? 'bg-accent text-bg font-bold' : 'text-muted hover:text-white'}`}
          >
          ...
          <Link
            ...
            className={`inline-flex min-h-[44px] items-center rounded px-2.5 py-1 can-hover:sm:min-h-0 ${tab === 'vndb' ? 'bg-accent text-bg font-bold' : 'text-muted hover:text-white'}`}
          >
            {t.tagPage.tabVndb}
          </Link>
        </nav>
      ...
      {tab === 'local' && (
        <section className="mt-6 rounded-xl border border-border bg-bg-card p-4 sm:p-6">
          ...
          {localItems.length === 0 ? (
            ...
            >
              {localItems.map((it) => (
                <div key={it.id} className="flex min-h-0 min-w-0 flex-col items-stretch self-stretch" data-vn-card-cell>
