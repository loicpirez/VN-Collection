...
- Production remains on the verified rollback release while the corrected
  candidate awaits explicit push and activation approval. The local browser
  and test evidence above does not claim that the public host already serves
  this candidate.
