...
| R14-UX-085 | MEDIUM | Cast cards stacked two 44-pixel links plus separate original-name text next to an 80-pixel portrait, creating excessive vertical gaps and making the seiyuu grid visibly sparse. Integrate the original name into the character target, use compact 32-pixel targets above the WCAG 24-pixel minimum, tighten line height and margins, and retain independent character and staff destinations. | VN cast and seiyuu cards | DONE_WITH_DIFF |
