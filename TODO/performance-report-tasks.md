...
| PERFA-009 | LOW | Stock offer rendering maps every provider result even when only a compact preview is visible. Paginate the data projection before rendering rows. | `src/components/StockPanel.tsx` | TODO |
